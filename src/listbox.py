...
try:
    from Tkinter import Frame, BOTH ,N,E,S, W, CENTER, Entry, Canvas, Label, Toplevel
    from tkFont import Font, nametofont
    from ttk import Treeview, Scrollbar, Style
except ImportError:
    from tkinter import Frame, BOTH ,N,E,S, W, CENTER, Entry, Canvas, Label, ttk, Toplevel
